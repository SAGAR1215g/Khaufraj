...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0CcSyO9gABAThiZIpMNetO4UoaRMOWqw8SI0mPECMAApMIAAJlPlhUrkPzM8m5N4oeBA")
...
ᴀɪᴍ[💖] sᴇᴀʀᴄʜ ᴩᴏᴡᴇʀᴇᴅ ʙʏ {config.MUSIC_BOT_NAME}"""
        ...
        if config.START_IMG_URL:
            try:
                await message.reply_sticker("CAACAgUAAx0CcSyO9gABAThiZIpMNetO4UoaRMOWqw8SI0mPECMAApMIAAJlPlhUrkPzM8m5N4oeBA-vHwMACAEAAwIAA3kABx4E")
